...
<html lang="en">
  ...
  <body>
  	<div class="container">
  		<div class="left">
			<h3>Updating to <?php echo _VERSION_ ?></h3>
			<ol>
  		...
  		<div class="right">
				<h1>Upgrading Premium URL Shortener to <?php echo _VERSION_ ?></h1> 
				<p>
					You are about to upgrade this software to version <strong><?php echo _VERSION_ ?></strong>. Please note that this will only update your database and NOT your files. It is strongly recommended that you first backup your database then your existing files in case something unexpected occurs. 
				</p>
				<p>
					Version <?php echo _VERSION_ ?> adds many new functionality including improvements in performance, features and security. For this reason, <strong>a lot of files</strong> were updated. <strong>Please read</strong> the update manual carefully in order to make sure the update is done as smoothly as possible. 
				</p>			
				<p>					
