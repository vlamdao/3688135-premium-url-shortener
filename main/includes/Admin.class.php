...
class Admin{
   ...
   * @since 5.5
   **/
  protected $actions = ["ads","users","urls","payments","pages","settings","themes","languages","help","search","subscription","tools","plans","update","emails","domains", "blog", "coupons"];
  /**
   * Config
   * @since 4.0
   **/
  ...
  protected function plans_add(){
    ...
    if(isset($_POST["token"])){
      ...
      $data = [
          ...
          ":trial_days" => Main::clean($_POST["trial_days"],3,TRUE),
  ...
  protected function blog(){
    ...
    private function blog_add(){
      ...
      <form action='".Main::ahref("blog/add")."' method='post' class='form-horizontal' role='form' enctype='multipart/form-data'>
        ...
        <hr>
        <p>Use the rich editor below to write your articles. To create an excerpt use <strong>{{--more--}}</strong> tag to split the artcile for the main page.</p><br>
          ...
          <div class="col-md-4">
             <div class="panel panel-default">
              ...
              <div class="panel-body">             
                ...
                <p><strong>Current PHP Version:</strong> '.phpversion().'</p>
                <p><strong>Last Update Released:</strong> '.$changes->date.'</p> 
                <p><strong>Envato Purchase code:</strong> '.$this->config["purchasecode"].'</p>
                <br>
                <a href="https://gempixel.com/changelog/premium-url-shortener" target="_blank" class="btn btn-sm btn-default">View Change Log</a>
              </div>
            </div>
          </div>
        </div>';  
  ...
  protected function header(){
    $update = $this->update_notification(true);
    include($this->t(__FUNCTION__));
  }
  /**
   * Footer
